		...
		<script>
			function kickSelected() {
				...
				for(var i = 0; i < table1.rows.length; i++) {
					if(table1.rows[i].cell[1].innerHTML != "NONE" && table1.rows[i].cell[0].children[0].checked) {
						extension += table1.rows[i].cell[0].children[0].name + ";";
					}
				}
				for(var i = 0; i < table2.rows.length; i++) {
					if(table2.rows[i].cell[1].innerHTML != "NONE" && table2.rows[i].cell[0].children[0].checked) {
						extension += table2.rows[i].cell[0].children[0].name + ";";
					}
				}
